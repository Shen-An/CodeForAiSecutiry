...
def main():
    ...
    # 汇总统计
    print("\n" + "="*80)
    print("Summary of Attack Results (SI-MI-FGSM with Ensemble)")
    print("="*80)
    ...
    if results:
        ...
        results_df.to_csv("./sim_ensemble_attack_results.csv", index=False)
        print(f"\nDetailed results saved to ./sim_ensemble_attack_results.csv")
    else:
