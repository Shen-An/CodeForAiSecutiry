...
def main(image_path):
    ...
    # 调整figsize以减小文件体积，每个子图约1.5英寸宽，300dpi下足够清晰
    fig, axs = plt.subplots(1, num_cols, figsize=(0.5 * num_cols, 1.55))
    ...
    # 调整间距：减小w_pad以缩短子图间距，保留pad防止过分紧凑
    plt.tight_layout(pad=0.15, w_pad=0.5, h_pad=0.04)
    # 根据需要取消注释其中一个保存语句
    plt.savefig('gradcam_results_original.png', dpi=300, bbox_inches='tight', pad_inches=0.02)
    plt.savefig('gradcam_results_original.eps', dpi=300, bbox_inches='tight', pad_inches=0.02)
    # plt.savefig('gradcam_results_transform.png', dpi=300, bbox_inches='tight', pad_inches=0.02)
    # plt.savefig('gradcam_results_transform.eps', dpi=300, bbox_inches='tight', pad_inches=0.02)
    # plt.savefig('gradcam_results_adv.png', dpi=300, bbox_inches='tight', pad_inches=0.02)
    # plt.savefig('gradcam_results_adv.eps', dpi=300, bbox_inches='tight', pad_inches=0.02)
    plt.show()
...
if __name__ == "__main__":
    # 使用示例图像
    # image_path = r"E:\TransferAttack\RuiGuoCode\results\PPSP\trans_debug\ILSVRC2012_val_00013528_iter10_idx1_trans.png"
    # image_path = r"E:\TransferAttack\RuiGuoCode\results\PPSP\trans_debug\ILSVRC2012_val_00013528_iter01_copy002.png"
    # image_path=r'D:\pycharm\python\Adversial\work_now\PMRT\transform_images_PHFRT\transformed_image.jpg'
    image_path = r"data/images/ILSVRC2012_val_00013528.png"
    # 运行完整版本
    # image_path =r"E:\TransferAttack\RuiGuoCode\results\PPSP\trans_debug\trans_vis_00013528_14.png"
